        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <li>
                <a href="{{ route('admin.orders.index') }}" class="nav-link px-0 align-middle">
                    <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Reservas</span></a>
            </li>
            <li>
                <a href="{{ route('admin.roomtypes.index') }}" class="nav-link px-0 align-middle">
                    <i class="fs-4 bi-grid"></i> <span class="ms-1 d-none d-sm-inline">Tipo Habitación</span></a>
            </li>
            <li>
                <a href="{{ route('admin.rooms.index') }}" class="nav-link px-0 align-middle">
                    <i class="fs-4 bi-grid"></i> <span class="ms-1 d-none d-sm-inline">Habitaciones</span></a>
            </li>
        </ul>
    </div>
</div>
